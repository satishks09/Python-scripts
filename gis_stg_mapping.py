...
# This is a modified version of testxml5
...
def gen_pkmd5(pk_attrib):
    ...
    for p in range(len(pk_attrib)):
        ...
        elif pk_attrib[p].get('DATATYPE').lower() == "num32" or pk_attrib[p].get('DATATYPE').lower() == "num16" or pk_attrib[p].get('DATATYPE').lower() == "integer" or pk_attrib[p].get('DATATYPE').lower() == "int" or pk_attrib[p].get('DATATYPE').lower() == "smallint" or pk_attrib[p].get('DATATYPE').lower() == "decimal" or pk_attrib[p].get('DATATYPE').lower() == "small integer":
...
for i in sources:
    ...
    for s in src_attrib:
        ...
        if (datatype.lower() == "varchar" or datatype.lower() == "char"):
            datatype = "string"
        elif datatype.lower() == "varbin":
            datatype = "binary"
        elif datatype.lower() == "packed":
            datatype = "decimal"
        elif datatype.lower() == "num32":
            datatype = "integer"
        elif datatype.lower() == "smallint" or datatype.lower() == "num16":
    ...
    getmd5_tfm_fld_pkmd5.set("PRECISION", "29")
...
for i in sources:
    ...
    inst_exp_ctl.set("TRANSFORMATION_NAME", "Exp_Ctl_Cols_2")
...
outfile_name = "m_src_img_sor_gis_wc_combined_cdc" + ".XML"
