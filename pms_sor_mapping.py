...
def gen_pkmd5(pk_attrib):
    ...
    for p in range(len(pk_attrib)):
        ...
        elif pk_attrib[p].get('DATATYPE').lower() == "num32" or pk_attrib[p].get('DATATYPE').lower() == "integer" or pk_attrib[p].get('DATATYPE').lower() == "int" or pk_attrib[p].get('DATATYPE').lower() == "smallint" or pk_attrib[p].get('DATATYPE').lower() == "decimal":
...
outfile_name = "m_src_pms_sor_combined" + ".XML"
